...
import ru.stonlex.api.bukkit.modules.protocol.packet.*;
import ru.stonlex.api.java.interfaces.Clickable;

import java.util.*;

@Getter
public abstract class AbstractFakeEntity {

    private static final TIntObjectMap<AbstractFakeEntity> entities = new TIntObjectHashMap<>();

    public static Collection<AbstractFakeEntity> getEntities() {
        return entities.valueCollection();
    }

    public static AbstractFakeEntity getEntityById(int id) {
    ...
    public AbstractFakeEntity(EntityType entityType, Location location) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && !(obj instanceof AbstractFakeEntity)) return false;

        AbstractFakeEntity fakeEntity = (AbstractFakeEntity) obj;
