...
public class TestOther {
    ...
    public void registerEvent() {
        Management.getEventManager().newBuilder(BlockBreakEvent.class)
                .setPlugin(moonAPI)
    ...
    public int getLastCraftPlayersCount() {
        return Management.getMessagingManager()
    ...
    public void sendMessage(Player player, String text) {
        Management.getMessagingManager().sendMessage(player.getName(),
    ...
    public void redirectPlayer(Player player, String serverName) {
        Management.getMessagingManager().redirectPlayer(player, serverName);
    }
